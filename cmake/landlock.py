"""
Samelessly copied from https://github.com/Edward-Knight/landlock
...
class FSAccess(enum.IntFlag):
    ...
    @classmethod
    def readonly(cls):
        return cls.READ_DIR | cls.READ_FILE | cls.EXECUTE
...
class Ruleset:
    ...
    def allow(self, *paths: Union[str, Path], rules: Optional[FSAccess] = None):
        if rules is None:
